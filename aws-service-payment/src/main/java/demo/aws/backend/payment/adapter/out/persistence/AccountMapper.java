...
import demo.aws.backend.payment.application.domain.model.Activity;
import demo.aws.backend.payment.application.domain.model.Activity.ActivityId;
import demo.aws.backend.payment.application.domain.model.ActivityWindow;
