...
public class RedisConfig {
    ...
    public LettuceConnectionFactory redisConnectionFactory() {
        ...
        RedisStaticMasterReplicaConfiguration masterReplicaConfiguration = new RedisStaticMasterReplicaConfiguration(
                this.getMaster().getHost(), this.getMaster().getPort());
        masterReplicaConfiguration.setPassword(RedisPassword.of(this.getMaster().password));
        this.getSlaves().forEach(slave -> masterReplicaConfiguration.addNode(slave.getHost(), slave.getPort()));
